...
var button = ['.gform_footer .gform_button', '.gform_page_footer .gform_button', '.gform_page_footer .gform_next_button','.gform_page_footer .gform_previous_button'];
...
$('<span class="customize-partial-edit-shortcut stla-partial-checkbox-shortcut">'+editCheckboxButton+'</span>').insertBefore('.ginput_container_consent');
